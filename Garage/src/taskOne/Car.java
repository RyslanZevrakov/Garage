...
public class Car extends Auto {
    ...
    public Car(String firma, int speed, String name, int n, Boolean f,String namders) {
        super(firma, speed,namders); //вызываем конструктор класса-родителя с параметрами
    ...
    public String toString() {
        return getFirm() + " " + getMaxSpeed() + " " + model + " " + numDoors + " " + fullTime + " " + getStateNumber() ;
    }
}
